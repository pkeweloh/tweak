...
export class ScheduleController {
  ...
  updateDateById(
    @Query('id') id: string,
    @Body() payload: { newDate: Date; order?: number; isSomeday?: number | null },
  ) {
    return this.scheduleService.updateDateById(id, payload.newDate, payload.order, payload.isSomeday);
  }
